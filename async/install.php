...
try {
    $dbh = new \PDO(
        'mysql:dbname='.$_POST['DATABASE_NAME'].';host='.$_POST['DATABASE_HOST'].';port=3306',$_POST['DATABASE_USER'],$_POST['DATABASE_PASS']
    );
    $DBFILE = "<?php
define('DATABASE_TYPE', /* データベースタイプ　 => */ 'mysql');
define('DATABASE_NAME', /* データベース名 => */ '".$_POST['DATABASE_NAME']."');
define('DATABASE_HOST', /* データベースホスト名　 => */ '".$_POST['DATABASE_HOST']."');
define('DATABASE_USER', /* データベースユーザー名 => */ '".$_POST['DATABASE_USER']."');
define('DATABASE_PASS', /* データベースパスワード => */ '".$_POST['DATABASE_PASS']."');";
    ...
    echo '{"result":1,"msg":"'.$result.'","class":"true"}';
} catch (\PDOException $e) {
    echo $e->getMessage();
    echo '{"result":0,"msg":"データベース設定ができません","class":"false"}';
}