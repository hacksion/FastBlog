...
class Retrieval extends DB
{
    ...
    public function col2val(string $col):string
    {
        return str_replace('`', '', $col);
    }
    public function getRecords(string $sql, array $place_holder, string $csv_sql = '')
    {
        $set_gor = false;
        if ($this->conditions) {
        ...
        $this->all_records = $this->execute('query', $sql, $place_holder);
        ...
        return $this->execute('query', $sql, $place_holder);
    }
}
